...
An enhanced date select form helper that allows you to use the full {HTML spec}[http://www.w3.org/TR/html5] for select
option elements (example: HTML5 data-* attributes, etc.) This is more than what you get with the
default Rails date select helper because it can allow values to persist in dropdowns.
